...
const Team = ({ params }) => {
  ...
  const [selectedGoalkeeperIndex, setSelectedGoalkeeperIndex] = useState(null);
    ...
    try {
      const { data: attackerStatsData, error: attackerStatsError } =
        await supabase
          ...
          .select("Card, Type, ID")
          .eq("Type", "forward")
          .in("Club_ID", ["C06", "C34", "C06", "C20", "C26", "C23"])
          .order("ID", { ascending: true });
          ...
          <div>
            {editMode && (
              <>
                ...
                >
                  <p className="p-3 font-semibold text-xl">Select Formation</p>
            ...
            <div
              ...
              style={{ gap: "15px", maxHeight: "970px", overflowY: "auto" }}
            >
              <div
                ...
                editMode && (
                  ...
                  >
                    ...
                    >
                      ...
                      {type === "midfielder" && renderMidfielderSelectorCards()}
                      {type === "forward" && renderAttackerSelectorCards()}
                      {type === "goalkeeper" && renderGoalkeeperSelectorCards()}
                    </div>
                  </div>
                )
              }
